 ...
 *            类名称（如果有命名空间，请携带命名空间，如：'Tencent\Model\Bar'）
 * @param string $methodName
 *            类内部的方法名称（可用是实例方法也可以是静态方法）
 ...
 */
function executeMethod($className, $methodName, $constructArgs = null, $methodArgs = null)
{
 ...
 */
function friendlyFormatTime($time = NULL, $format = 'Y-m-d H:i')
{
